...
class NotificationService {
    ...
    public function printUserIdentityDetails($identityInfo) {
        ...
        if ($identityInfo['identityInfo']['personal_photo'])
            $info .= '<b>' . trans('identity.other_info') . '</b> <br /><img src="' . asset('storage/' . $identityInfo['identityInfo']['personal_photo']) . '"/> <br>';
        if ($identityInfo['identityInfo']['attachments'])
            $info .= '<b>' . trans('identity.other_attachment') . '</b> <br /><img src="' . asset('storage/' . $identityInfo['identityInfo']['attachments']) . '"/> <br>';
        if ($identityInfo['identityInfo']['transcript'])
            $info .= '<b>' . trans('identity.transcript') . '</b> <br /><img src="' . asset('storage/' . $identityInfo['identityInfo']['transcript']) . '"/> <br>';
        return $info;
    }
}
