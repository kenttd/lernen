    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="am-session-detail">
            <div class="am-session-detail_sidebar">
                ...
                <ul class="am-session-duration">
                    ...
                    <li>
                        <div class="am-session-duration_title">
                            <figure>
                                @if(!empty($currentBooking?->tutor?->image) && Storage::disk('public')->exists($currentBooking?->tutor?->image))
                                    <img src="{{ resizedImage($currentBooking?->tutor?->image, 24, 24) }}" alt="{{ $currentBooking?->tutor?->full_name }}">
                                @else
                                    <img src="{{ resizedImage('placeholder.png', 24, 24) }}" alt="{{ $currentBooking?->tutor?->full_name }}">
                                @endif
                            </figure>
            ...
            <div class="am-session-detail-modal_body">
                <figure>
                    @if(!empty($currentBooking?->slot?->subjectGroupSubjects?->image) && Storage::disk('public')->exists($currentBooking?->slot?->subjectGroupSubjects?->image))
