                ...
                <div class="am-dbbox_content">
                    <div x-data="{current_method:@entangle('form.current_method')}" class="am-payout_wrap">
                        ...
                        <div wire:key=$method.'-'.time()}}" class="am-payout_item">
                            ...
                            @if ($item['price'])
                            <strong><sup>{!! getCurrencySymbol() !!}</sup>{{ number_format($item['price'],2) }}</strong>
                            @endif
                            @if ($item['status'])
                            ...
                            <div class="am-radio">
                                ...
                                <label for="default_{{ $method }}">{{ __('Make Default Method') }}</label>
                                @else
                                <strong>{{ $item['title'] }}</strong>
                                @if(!$item['price'] > 0)
                                <span>{{ __('No account added yet') }}</span>
                                @endif
                                @endif
                            </div>
