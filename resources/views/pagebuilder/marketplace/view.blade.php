        ...
        <div class="row">
            <div class="col-12">
                @if(!empty(pagesetting('pre_heading')) 
                    ...
                    || !empty(pagesetting('bullets_heading')) 
                    ...
                    <div class="am-marketplace_content">
                        @if(!empty(pagesetting('pre_heading')) 
                            ...
                            <div class="am-marketplace_content_list">
                                ...
                                @endif 
                                @if(!empty(pagesetting('bullets_heading')) || !empty(pagesetting('list-data')))    
                                    <div class="am-marketplace_content_list_details">
                                        <!-- @if(!empty(pagesetting('bullets_heading'))) <h4>{{ pagesetting('bullets_heading') }}</h4> @endif  -->
                        ...
                        @if(!empty(pagesetting('image')))
                            <div class="am-marketplace_content_video">
                                @if(!empty(pagesetting('image')[0]['path']))
                                    <img src="{{asset('storage/'.pagesetting('image')[0]['path'])}}" alt="image">
                                @endif
                            </div>
                        @endif
                    </div>
