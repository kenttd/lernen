...
<div class="am-banner-potential am-banner-content-four">
    ...
    @if(!empty(pagesetting('bg_img_one')) || !empty(pagesetting('bg_img_two')) || !empty(pagesetting('bg_img_three')))
        @if(!empty(pagesetting('bg_img_one')))
            <img class="am-bgimg1" src="{{asset('storage/'.pagesetting('bg_img_one')[0]['path'])}}" alt="image"> 
        @endif
        @if(!empty(pagesetting('bg_img_two')))
            <img class="am-bgimg2" src="{{asset('storage/'.pagesetting('bg_img_two')[0]['path'])}}" alt="image"> 
        @endif
        @if(!empty(pagesetting('bg_img_three')))
            <img class="am-bgimg3" src="{{asset('storage/'.pagesetting('bg_img_three')[0]['path'])}}" alt="image"> 
        @endif
    @endif
    <img class="am-bgimg4" src="{{ asset('demo-content/home-v2/banner/bg-boxs.png') }}" alt="bg boxs">
</div>
