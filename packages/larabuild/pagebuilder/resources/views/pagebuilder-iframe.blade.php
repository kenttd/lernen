...
@section(config('pagebuilder.site_section'))
    {{-- <div id="grids" class="{{ $page->slug == 'home-three' ? 'page-home-three' : ($page->slug == 'home-four' ? 'page-home-four' : '') }}"> --}}
        <div id="grids" class="{{ 
            $page->slug == 'home-three' ? 'page-home-three' : 
            ($page->slug == 'home-four' ? 'page-home-four' : 
            ($page->slug == 'home-five' ? 'page-home-five' : '')) 
        }}">
