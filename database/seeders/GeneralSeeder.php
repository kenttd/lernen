...
class GeneralSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Storage::disk('public')->putFileAs('', public_path('demo-content/placeholders/placeholder.png'), 'placeholder.png');
        Storage::disk('public')->putFileAs('', public_path('demo-content/placeholders/placeholder-land.png'), 'placeholder-land.png');
        Storage::disk('public')->putFileAs('', public_path('demo-content/placeholders/blog-default.png'), 'blog-default.png');
    }
}
